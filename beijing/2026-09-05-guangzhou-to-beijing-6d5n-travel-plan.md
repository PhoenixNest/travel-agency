...
>
> - **✅ 已成功锁定出票**：**天坛公园**（Day 1 下午联票）、**天安门广场**（Day 2 晨间）、**中国国家博物馆**（Day 2 上午）、**故宫博物院**（Day 2 下午）、**颐和园**（Day 4 上午联票）、**圆明园遗址公园**（Day 4 下午通票）；
...
> **💡 智库关键前置动作提示**：首批四大核心场馆（天坛、天安门、国博、故宫）及第四天皇家园林（颐和园联票、圆明园通票）已全部成功锁定出票；对于后续待办场馆，请贵宾务必在闹钟响铃时（**放票前 5 分钟**），提前打开对应官方小程序/平台并**预先录入好所有同行人的姓名与二代身份证号**。放票瞬间直接勾选提交，无需临时输入！
